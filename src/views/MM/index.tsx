...
export default function MM() {
    ...
    const onShowPatchBox = () => setShowPatchBox(false);
    ...
    // event handler: 검색어 변경 이벤트 처림 함수 //
    ...
    return (
        <div id='mm-wrapper'>
            ...
            {showPatchBox && <PatchBox unShow={onShowPatchBox} getToolList={getToolList} toolNumber={patchToolNumber} />}
            <div className='top'>
