...
import { GetCareRecordResponseBodyDto, GetCustomerResponseDto } from 'src/apis/dto/response/customer';
...
export default function CSDetail() {
    ...
    const getCareRecordListResponse = (responseBody: GetCareRecordResponseBodyDto | ResponseDto | null) => {
        const message = 
            !responseBody ? '서버에 문제가 있습니다' : 
            responseBody.code === 'VF' ? '잘못된 접근입니다' : 
            responseBody.code === 'AF' ? '잘못된 접근입니다' : 
        ...
        const { careRecords } = responseBody as GetCareRecordResponseBodyDto;
