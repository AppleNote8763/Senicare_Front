...
export default function Auth() {
    ...
    const onPatchChangeHandler = (path: AuthPath) => {
        setPath(path);
    }

    // effect: 첫 로드시에 Query Parameter의 snsId와 joinPath 존재시 회원가입 화면전환 함수 //
    useEffect(() => {
    ...
    return (
        <div id="auth-wrapper">
            ...
            <div className="auth-container">
                {path === '로그인' ?
                    <SignIn onPathChange={onPatchChangeHandler} /> :
                    <SignUp onPathChange={onPatchChangeHandler} />
                }
            </div>
